...
import MessageBoard from "./MessageBoard"; // new
...
export default function Dashboard({ user }) {
  ...
  useEffect(() => {
    if (tab === "my-courses") {
      axios
        .get("http://localhost:5000/api/my-courses", { withCredentials: true })
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-4 flex gap-4">
        ...
        <button
          className={`px-4 py-2 rounded ${tab === "messages" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
